...
{
  new (message_memory) dlrobot_robot_msg::msg::Data(_init);
}

void Data_fini_function(void * message_memory)
{
  auto typed_message = static_cast<dlrobot_robot_msg::msg::Data *>(message_memory);
  typed_message->~Data();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Data_message_member_array[3] = {
  {
    ...
    offsetof(dlrobot_robot_msg::msg::Data, x),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(dlrobot_robot_msg::msg::Data, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(dlrobot_robot_msg::msg::Data, z),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Data_message_members = {
  "dlrobot_robot_msg::msg",  // message namespace
  "Data",  // message name
  3,  // number of fields
  sizeof(dlrobot_robot_msg::msg::Data),
...
{
  return &::dlrobot_robot_msg::msg::rosidl_typesupport_introspection_cpp::Data_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dlrobot_robot_msg, msg, Data)() {
  return &::dlrobot_robot_msg::msg::rosidl_typesupport_introspection_cpp::Data_message_type_support_handle;
}
