...
bool dlrobot_robot_msg__msg__data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dlrobot_robot_msg.msg._data.Data", full_classname_dest, 32) == 0);
  }
  dlrobot_robot_msg__msg__Data * ros_message = _ros_message;
  {  // x
...
PyObject * dlrobot_robot_msg__msg__data__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("dlrobot_robot_msg.msg._data");
